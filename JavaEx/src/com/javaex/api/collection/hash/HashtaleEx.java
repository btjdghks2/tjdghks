...
public class HashtaleEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("505 이 있는가?" + map.containsKey("505"));
		
		// 값 중에서 subject가 java인 값이 있는가? : containsKey
		System.out.println("Java가 값이 있는가?"
